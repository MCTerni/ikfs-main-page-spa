...
import team7 from "../../img/team/team-7.jpg"
import team8 from "../../img/team/team-8.jpg"
import team9 from "../../img/team/team-9.jpg"
import team10 from "../../img/team/team-10.jpg"
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="team-title">
                                ...
                                <a href="contact" className="primary-btn btn-normal appoinment-btn">Fale com a gente</a>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="ts-item set-bg" style={{backgroundImage:`url(${team7})`}}>
                                <div className="ts_text">
                                    <h4>Athart Rachel</h4>
                                    <span>Gym Trainer</span>
                                    <div className="tt_social">
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="ts-item set-bg" style={{backgroundImage:`url(${team8})`}}>
                                <div className="ts_text">
                                    <h4>Athart Rachel</h4>
                                    <span>Gym Trainer</span>
                                    <div className="tt_social">
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="ts-item set-bg" style={{backgroundImage:`url(${team9})`}}>
                                <div className="ts_text">
                                    <h4>Athart Rachel</h4>
                                    <span>Gym Trainer</span>
                                    <div className="tt_social">
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="ts-item set-bg" style={{backgroundImage:`url(${team10})`}}>
                                <div className="ts_text">
                                    <h4>Athart Rachel</h4>
                                    <span>Gym Trainer</span>
                                    <div className="tt_social">
